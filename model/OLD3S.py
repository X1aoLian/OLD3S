...
class OLD3S:
    def __init__(self, data_S1, label_S1, data_S2, label_S2, T1, t, b=0.9, lr=0.01, s=0.008, m=0.9, spike=9e-5,
    ...
    def FirstPeriod(self):
        ...
        for (i, x) in enumerate(data1):
            ...
            if self.i < self.B:
                ...
                if i == self.B:
                    ...
                    torch.save(self.net_model1.state_dict(), './data/parameter_hedge/net_model1_ensenmble_W.pth')
                ...
                if len(self.cl_1) == 100:
                    ...
                    self.cl_2.pop(0)
                try:
                    a_cl_1 = math.exp(beta * sum(self.cl_1))
                    a_cl_2 = math.exp(beta * sum(self.cl_2))
                    self.a_1 = (a_cl_1) / (a_cl_2 + a_cl_1)
                except OverflowError:
                    self.a_1 = float('inf')
                self.a_2 = 1 - self.a_1
                optimizer_2_2.zero_grad()
                loss_2_1 = self.KLDivLoss(x2, decoded_2)
                loss_2_2 = self.KLDivLoss(encoded_2, encoded_1)
        ...
        torch.save(self.net_model2.state_dict(), './data/parameter_hedge/net_model2_ensenmble_W.pth')
    ...
    def SecondPeriod(self):
        ...
        pretrain_dict = torch.load('./data/parameter_hedge/net_model1_ensenmble_W.pth')
        ...
        pretrain_dict = torch.load('./data/parameter_hedge/net_model2_ensenmble_W.pth')
        ...
        for (i, x) in enumerate(data2):
            ...
            loss_5 = self.KLDivLoss(x, decoded)
            loss_5.backward()
            optimizer_5.step()
        ...
        torch.save(self.S1_Figure_Accuracy, './data/deepFESL_accuracy_W')
